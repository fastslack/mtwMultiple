--
-- Table structure for table `#__mtwmultiple_sites`
--

CREATE TABLE IF NOT EXISTS `#__mtwmultiple_sites` (
...
--
-- Table structure for table `#__mtwmultiple_extensions`
--

CREATE TABLE IF NOT EXISTS `#__mtwmultiple_extensions` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
